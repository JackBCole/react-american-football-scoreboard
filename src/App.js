...
function App() {
  ...
  <button onClick = {homeTouchDown}className="homeButtons__touchdown">TouchDown</button>
          <button onClick = {homeFieldGoal}className="homeButtons__fieldGoal">Home Field Goal</button>
        </div>
        <div  className="awayButtons">
  <button  onClick = {awayTouchDown} className="awayButtons__touchdown">TouchDown</button>
